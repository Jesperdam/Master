...
Factmont<- read.table("6_Portfolios_ME_Prior_60_13.txt",
                      skip=541,
                      nrows=492,
...
write.table(cbind(Factmont[61:(nrow(na.omit(framed))+60),1],na.omit(framed)),"oosy2005_1m_ltr.txt",
            row.names=F)
...
write.table(cbind(Factmont[73:(nrow(na.omit(framed))+72),1],na.omit(framed)),"oosy2005_1y_ltr.txt",
            row.names=F)

...
plot(y=oosr2,x=seq(fin-(length(oosr2)*1/12)+1/12,to=fin,by=1/12),type="l",
     ylab="Out-of-sample R.squared", xlab="Time",main="10x10 Pfs",xaxt="n",ylim=c(-10,10))
abline(0,0)
axis(1,xaxp=c(1940,2010,7),las=2)
pencnew <- pt(-abs(encnew),(length(oosr2)-1))*2
write.table(cbind(frame,c(oosr2,rep(NA,60)),c(pencnew,rep(NA,60))),"frame1010IS_1m_40y.txt",

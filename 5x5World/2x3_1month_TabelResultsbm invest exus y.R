...
write.table(cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed)),"oosy2005_y_inv_exus.txt",
            row.names=F)
xtable(rbind(cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[115,2:3],
             ...
             cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[115,10:11]),digits=3)

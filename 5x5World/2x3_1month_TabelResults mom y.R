...
bm <- read.table("Global_25_Portfolios_ME_BE-ME.txt",skip=22,nrows=308,
...
write.table(cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed)),"oosy2005_y_mom_w.txt",
            row.names=F)

...
bm <- read.table("Global_ex_US_25_Portfolios_ME_BE-ME.txt",skip=22,nrows=306,
...
write.table(cbind(Factmont[61:(nrow(na.omit(framed))+60),1],na.omit(framed)),"oosy2005_m_ind_ex.txt",
            row.names=F)

...
Factmont<- read.table("6_Portfolios_ME_Prior_12_2.txt",
                      skip=775,
                      nrows=308,
...
bm <- read.table("Global_ex_US_25_Portfolios_ME_BE-ME.txt",skip=22,nrows=308,
...
write.table(cbind(Factmont[61:(nrow(na.omit(framed))+60),1],na.omit(framed)),"oosy2005_m_mom_ex.txt",
            row.names=F)
xtable(rbind(cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[104,2:3],
             cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[104,4:5],
             cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[104,6:7],
             cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[104,8:9],
             cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[104,10:11],
             cbind(Factmont[72:(nrow(na.omit(framed))+71),1],na.omit(framed))[104,12:13]),digits=3)

  ...
  setwd("C:/Users/jesper/OneDrive/Master Thesis/Data testing/rstuff/5x5 + 2x20")
...
pencnew <- pt(-abs(encnew),(length(oosr2)-1))*2
  write.table(cbind(frame,c(oosr2,rep(NA,60)),c(pencnew,rep(NA,60))),"frame5x5IS_1y_40y.txt",

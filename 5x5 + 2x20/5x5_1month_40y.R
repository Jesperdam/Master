...
plot(y=oosr2,x=seq(fin-(length(oosr2)*1/12)+1/12,to=fin,by=1/12),type="l",
     ylab="Out-of-sample R.squared", xlab="Time",main="5x5 Pfs",ylim=c(-20,10),xaxt="n")
axis(1,xaxp=c(1940,2010,7),las=2)
abline(0,0)
pencnew <- (1-pt(encnew,(length(oosr2)-1)))*2
write.table(cbind(frame,c(oosr2,rep(NA,60)),c(pencnew,rep(NA,60))),"frame5x52x20IS_1m_40y.txt",

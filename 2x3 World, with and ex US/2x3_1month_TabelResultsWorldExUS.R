...
Factmont<- read.table("Global_ex_US_6_Portfolios_ME_BE-ME.txt",
                      skip=22,
                      nrows=306,
...
write.table(na.omit(framed),"oosy2005_worldexus.txt",
            row.names=F)
